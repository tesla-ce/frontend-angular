import {AfterViewInit, Component, Input, OnInit, SimpleChanges, ViewChildren} from '@angular/core';
...
export class EnrolmentStatusComponent implements OnInit, AfterViewInit {
